...
const TESTS = [
  ...
  { slug: 'amilaza', title: 'Амилаза', unit: 'Ед/л', category: 'Биохимия',
    mMin: 25, mMax: 125, fMin: 25, fMax: 125,
    lowCauses: 'Хронический панкреатит с истощением железы, муковисцидоз, удаление поджелудочной железы.',
    highCauses: 'Острый панкреатит (повышение в 3–5 раз), паротит (свинка), перфорация язвы, кишечная непроходимость.',
    lowDoctor: 'гастроэнтеролог', highDoctor: 'гастроэнтеролог',
    lowTips: 'Сдайте также липазу и эластазу кала.', highTips: 'При > 3× нормы — подозрение на острый панкреатит. Сдайте липазу и УЗИ поджелудочной железы.',
  },
  { slug: 'lipaza', title: 'Липаза', unit: 'Ед/л', category: 'Биохимия',
    mMin: 0, mMax: 60, fMin: 0, fMax: 60,
    lowCauses: 'Снижение не имеет клинического значения.',
    highCauses: 'Острый панкреатит (наиболее специфичный маркёр), хронический панкреатит в стадии обострения, камни желчного пузыря.',
    lowDoctor: '-', highDoctor: 'гастроэнтеролог',
    lowTips: '', highTips: 'Липаза специфичнее амилазы. При > 3× нормы — острый панкреатит до опровержения. Сдайте амилазу, УЗИ брюшной полости.',
  },
  { slug: 'shchelochnaya-fosfataza', title: 'Щелочная фосфатаза (ЩФ)', unit: 'Ед/л', category: 'Биохимия',
    mMin: 40, mMax: 130, fMin: 35, fMax: 105,
    lowCauses: 'Гипотиреоз, дефицит цинка, пернициозная анемия — редко клинически значимо.',
    highCauses: 'Холестаз (закупорка желчных путей), болезни костей (Педжета, рахит, метастазы в кости), беременность (3-й триместр) — физиологически.',
    lowDoctor: 'терапевт', highDoctor: 'гастроэнтеролог или терапевт',
    lowTips: 'Проверьте функцию щитовидной железы.', highTips: 'Для разграничения печёночной и костной причины сдайте ГГТ — если ГГТ тоже повышен, источник печень. Сдайте АЛТ, АСТ, билирубин.',
  },
  { slug: 'ggt', title: 'ГГТ (гамма-глутамилтрансфераза)', unit: 'Ед/л', category: 'Биохимия',
    mMin: 10, mMax: 71, fMin: 6, fMax: 42,
    lowCauses: 'Клинического значения не имеет.',
    highCauses: 'Алкогольная болезнь печени (очень чувствительный маркёр), холестаз, жировой гепатоз, приём статинов, фенитоина.',
    lowDoctor: '-', highDoctor: 'гастроэнтеролог или терапевт',
    lowTips: '', highTips: 'ГГТ — самый чувствительный маркёр злоупотребления алкоголем. Нормализуется через 2–4 недели после отказа. Сдайте АЛТ, АСТ, ЩФ.',
  },
  { slug: 'albumin', title: 'Альбумин', unit: 'г/л', category: 'Биохимия',
    mMin: 35, mMax: 52, fMin: 35, fMax: 52,
    lowCauses: 'Цирроз печени, нефротический синдром (потеря с мочой), недоедание, хронические воспалительные заболевания, ожоги.',
    highCauses: 'Обезвоживание (относительное повышение). Абсолютного повышения практически не бывает.',
    lowDoctor: 'терапевт или гастроэнтеролог', highDoctor: 'терапевт',
    lowTips: 'Альбумин < 30 г/л — выраженная гипоальбуминемия, риск отёков. Сдайте белок в моче, печёночные пробы.', highTips: 'Выпейте больше воды и пересдайте.',
  },
  { slug: 'kaliy', title: 'Калий', unit: 'ммоль/л', category: 'Биохимия',
    mMin: 3.5, mMax: 5.1, fMin: 3.5, fMax: 5.1,
    lowCauses: 'Приём диуретиков (тиазидных, петлевых), рвота и диарея, гиперальдостеронизм, дефицит в пище.',
    highCauses: 'Почечная недостаточность, ацидоз, приём калийсберегающих диуретиков, иАПФ, бета-блокаторов, рабдомиолиз.',
    lowDoctor: 'терапевт', highDoctor: 'терапевт или нефролог',
    lowTips: 'При < 3.0 — риск аритмий. Сделайте ЭКГ. При приёме диуретиков назначают препараты калия.', highTips: 'При > 5.5 — риск опасных аритмий. Сделайте ЭКГ срочно. Исключите гемолиз пробы.',
  },
  { slug: 'natriy', title: 'Натрий', unit: 'ммоль/л', category: 'Биохимия',
    mMin: 136, mMax: 145, fMin: 136, fMax: 145,
    lowCauses: 'Приём диуретиков, сердечная или почечная недостаточность, цирроз печени, синдром неадекватной секреции АДГ (SIADH), рвота.',
    highCauses: 'Обезвоживание, несахарный диабет, избыток натрия в питании, первичный гиперальдостеронизм.',
    lowDoctor: 'терапевт', highDoctor: 'терапевт или эндокринолог',
    lowTips: 'Гипонатриемия < 125 ммоль/л — риск отёка мозга. Срочная госпитализация. Коррекция медленная во избежание осмотической демиелинизации.', highTips: 'Исключите обезвоживание. Увеличьте потребление воды. При стойкой гипернатриемии — обследование на несахарный диабет.',
  },
  { slug: 'magniy', title: 'Магний', unit: 'ммоль/л', category: 'Биохимия',
    mMin: 0.66, mMax: 1.07, fMin: 0.66, fMax: 1.07,
    lowCauses: 'Алкоголизм, диарея, приём диуретиков, сахарный диабет (полиурия), низкое потребление с пищей.',
    highCauses: 'Почечная недостаточность (нарушено выведение), приём антацидов содержащих магний, передозировка препаратов магния.',
    lowDoctor: 'терапевт', highDoctor: 'нефролог или терапевт',
    lowTips: 'Дефицит магния часто сопровождает дефицит калия и кальция. Симптомы: судороги, тремор, тахикардия. Коррекция препаратами магния.', highTips: 'Гипермагниемия > 2 ммоль/л — слабость, гипотония. Обследование функции почек.',
  },
  { slug: 'fsg', title: 'ФСГ', unit: 'МЕ/л', category: 'Гормоны',
    mMin: 1.5, mMax: 12.4, fMin: 2.8, fMax: 11.3,
    lowCauses: 'Гипопитуитаризм, приём экзогенных эстрогенов или андрогенов, ожирение, нервная анорексия.',
    highCauses: 'У женщин: менопауза, первичная яичниковая недостаточность. У мужчин: первичный гипогонадизм, крипторхизм.',
    lowDoctor: 'эндокринолог или репродуктолог', highDoctor: 'гинеколог или эндокринолог',
    lowTips: 'Оценивайте ФСГ всегда вместе с ЛГ, эстрадиолом (у женщин) или тестостероном (у мужчин).', highTips: 'ФСГ > 10 у женщин до 40 лет — признак снижения овариального резерва. Сдайте АМГ и эстрадиол.',
  },
  { slug: 'estradiol', title: 'Эстрадиол (E2)', unit: 'пмоль/л', category: 'Гормоны',
    mMin: 40, mMax: 161, fMin: 68, fMax: 1269,
    lowCauses: 'Менопауза, первичная яичниковая недостаточность, гипопитуитаризм, нервная анорексия, интенсивные физические тренировки.',
    highCauses: 'Опухоли яичников, цирроз печени (нарушение метаболизма), ожирение, приём ксеноэстрогенов. У мужчин: гинекомастия.',
    lowDoctor: 'гинеколог или эндокринолог', highDoctor: 'гинеколог',
    lowTips: 'Низкий эстрадиол у женщин репродуктивного возраста — риск остеопороза. Сдайте ФСГ, АМГ.', highTips: 'У мужчин повышенный эстрадиол вызывает гинекомастию и снижение либидо. Сдайте тестостерон и ФСГ.',
  },
  { slug: 'progesteron', title: 'Прогестерон', unit: 'нмоль/л', category: 'Гормоны',
    mMin: 0.3, mMax: 2.2, fMin: 0.3, fMax: 89.0,
    lowCauses: 'Ановуляторный цикл (овуляции не было), лютеиновая недостаточность, угроза выкидыша, синдром поликистозных яичников.',
    highCauses: 'Беременность (норма), лютеиновая киста яичника, врождённая гиперплазия надпочечников.',
    lowDoctor: 'гинеколог или репродуктолог', highDoctor: 'гинеколог',
    lowTips: 'Прогестерон сдают на 21–23 день цикла (7-й день после овуляции). Уровень < 9 нмоль/л в этот период указывает на отсутствие овуляции.', highTips: 'При задержке менструации и высоком прогестероне — сделайте тест на беременность.',
  },
  { slug: 'psa-obshchiy', title: 'ПСА общий', unit: 'нг/мл', category: 'Иммунология',
    mMin: 0, mMax: 4.0, fMin: 0, fMax: 4.0,
    lowCauses: 'Норма — не имеет клинического значения.',
    highCauses: 'Рак предстательной железы, доброкачественная гиперплазия (аденома) простаты, простатит, после ПРИ или ТРУЗИ.',
    lowDoctor: '-', highDoctor: 'уролог',
    lowTips: '', highTips: 'ПСА 4–10 — «серая зона», нужна биопсия простаты. ПСА > 10 — высокий риск рака. Важно: ПСА не специфичен для рака, повышается и при аденоме.',
  },
  { slug: 'ca-125', title: 'CA-125', unit: 'МЕ/мл', category: 'Иммунология',
    mMin: 0, mMax: 35, fMin: 0, fMax: 35,
    lowCauses: 'Норма — не имеет клинического значения.',
    highCauses: 'Рак яичников, эндометриоз, миома матки, воспалительные заболевания органов малого таза, перикардит, плеврит.',
    lowDoctor: '-', highDoctor: 'гинеколог или онколог',
    lowTips: '', highTips: 'CA-125 не используется для скрининга — много ложноположительных. Применяется для мониторинга лечения рака яичников. Сдайте УЗИ органов малого таза.',
  },
...
// ─── Основной компонент ────────────────────────────────────────────────────────
export default function DecodePageClient() {
