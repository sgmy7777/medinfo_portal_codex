...
export const metadata: Metadata = {
  ...
  description: 'Онлайн медицинские калькуляторы: ИМТ, идеальный вес, норма калорий, воды, пульсовые зоны, СКФ и HOMA-IR.',
  openGraph: {
    title: 'Медицинские калькуляторы — ЗдравИнфо',
    description: 'ИМТ, идеальный вес, норма калорий, воды и пульсовые зоны — быстро и без регистрации.',
    type: 'website',
  },
}
